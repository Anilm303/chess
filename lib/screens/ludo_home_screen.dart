...
class _LudoHomeScreenState extends State<LudoHomeScreen>
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    top: 30,
                    child: _glowBlob(
                      const Color(0xFFFFD54A).withOpacity(0.12),
                      220,
                    ),
                  ),
                  SafeArea(
  ...
  Widget _slotToggleButton(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selected ? Colors.white.withOpacity(0.28) : Colors.black12,
  ...
  void _launchOfflineGame(BuildContext context, int playerCount) {
    ...
    for (int i = 0; i < playerCount && i < _slotColors.length; i++) {
      final slotType = i < _playerSlots.length
          ? _playerSlots[i]
          : _PlayerSlotType.human;
      players.add(
        Player(
      ...
      players.add(
        Player(
          ...
          name: slot == _PlayerSlotType.human
              ...
              : 'Computer ${i + 1}',
          color: _slotColors[i],
          type: slot == _PlayerSlotType.human
              ? PlayerType.human
              : PlayerType.ai,
