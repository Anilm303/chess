...
class _LudoGameScreenState extends State<LudoGameScreen>
            ...
            WidgetsBinding.instance.addPostFrameCallback((_) async {
              ...
              await showModalBottomSheet(
                ...
                builder: (ctx) {
                  ...
                  final acceptCount =
                      votes != null ? (votes['accept'] ?? 0) : 0;
                  final rejectCount =
                      votes != null ? (votes['reject'] ?? 0) : 0;
  ...
  Widget _buildTurnColorBox(
    ...
    return AnimatedContainer(
      ...
      height: 48,
      decoration: BoxDecoration(
        color: colorValue.withAlpha(isActive ? 255 : (0.25 * 255).round()),
        borderRadius: BorderRadius.circular(10),
        border: Border.all(
          color: isActive ? Colors.black87 : colorValue.withAlpha(217),
          width: isActive ? 2.5 : 1.0,
        ),
        boxShadow: isActive
            ? [
                BoxShadow(
                  color: colorValue.withAlpha(89),
                  blurRadius: 10,
  ...
  Widget _buildTokenCard(Token token, GameProvider gameProvider) {
    ...
    final canTap = gameProvider.currentPlayer?.type == PlayerType.human &&
        gameProvider.diceRolled &&
        !gameProvider.awaitingServer;
