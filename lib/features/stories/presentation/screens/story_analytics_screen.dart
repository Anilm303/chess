              ...
              : SingleChildScrollView(
                  child: Column(
                    children: [
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                final viewer = (analytics!['viewers']
                      ...
                      // Reactions section
                      if ((analytics!['reaction_details'] as Map?)
                              ?.isNotEmpty ??
                          false)
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            ListView.builder(
                              shrinkWrap: true,
                              physics: const NeverScrollableScrollPhysics(),
                              itemCount: (analytics!['reaction_details'] as Map)
                                  .length,
                              itemBuilder: (context, index) {
                                final entries =
                                    (analytics!['reaction_details'] as Map)
                                        .entries
                                        .toList();
                                final username = entries[index].key;
                                final reaction = entries[index].value
                            ...
                            child: Column(
                              children: [
                                Icon(
                                  ...
                                  size: 64,
                                  color:
                                      MessengerColors.messengerBlue.withAlpha(
                                    51,
                                  ),
                                ),
                                const SizedBox(height: 16),
      ...
      child: Row(
        children: [
          ...
          Icon(
            Icons.visibility,
            size: 18,
            color: MessengerColors.messengerBlue.withAlpha(153),
          ),
        ],
      ),
    );
